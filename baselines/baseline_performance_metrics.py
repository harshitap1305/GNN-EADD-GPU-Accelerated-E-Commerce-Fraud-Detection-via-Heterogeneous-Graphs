...
def load_evaluation_data():
    ...
    # FIX: Use 'node_counts.json' and the key 'users' to match your project
    try:
    ...
    N_u = counts['users']  # Changed from mapping['N_u']
    ...
    try:
        # These are the files generated by your updated baseline scripts
