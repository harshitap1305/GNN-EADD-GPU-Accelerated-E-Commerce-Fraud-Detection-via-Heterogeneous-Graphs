...
#             H_user = W_pu(raw_pu) + W_uu(raw_uu)
#             # FIX: Only apply ReLU on the hidden layer, leave latent Z linear
...
#             H_product = W_up(raw_up) + W_ps(raw_ps)
...
#         pu_src, pu_dst = sample_positive_edges(epu_rp, epu_ci, src_offset=0, num_samples=50000)
#         ps_src, ps_dst = sample_positive_edges(eps_rp, eps_ci, src_offset=N_u, num_samples=50000)
#         uu_src, uu_dst = sample_positive_edges(euu_rp, euu_ci, src_offset=0, num_samples=50000)
